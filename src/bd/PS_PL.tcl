...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.CLKIN1_JITTER_PS {200.0} CONFIG.CLKOUT1_JITTER {177.254} CONFIG.CLKOUT1_PHASE_ERROR {162.020} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {49.162} CONFIG.PRIM_IN_FREQ {50.000} CONFIG.RESET_TYPE {ACTIVE_LOW}  ] $clk_wiz_0
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins n3_te0722_0/rs232_from_bt] [get_bd_pins n3_te0722_0/rs232rx] [get_bd_pins xlconstant_0/dout]
